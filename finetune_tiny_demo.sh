...
# wget -P ./bin/ckpt https://af3-dev.tos-cn-beijing.volces.com/release_model/protenix_tiny_default_v0.5.0.pt

checkpoint_path="./bin/ckpt/protenix_tiny_default_v0.5.0.pt"

# torchrun --nproc_per_node=2
PYTHONPATH=./ python ./runner/train.py \
--model_name "protenix_tiny_default_v0.5.0" \
--run_name protenix_tiny_finetune_mem \
--seed 42 \
--base_dir ./output \
--dtype bf16 \
--project protenix \
