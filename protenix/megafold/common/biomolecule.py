...
from megafold.life import DNA_NUCLEOTIDES, HUMAN_AMINO_ACIDS, RNA_NUCLEOTIDES
...
from megafold.utils.utils import exists, not_exists, np_mode
...
def to_mmcif(
    ...
    :param insert_megafold_mmcif_metadata: If True, insert metadata fields
        referencing MegaFold in the output mmCIF file.
...
def to_inference_mmcif(
    ...
    """Converts an `MegaFoldInput`-derived `Biomolecule` instance to an mmCIF string. Clone of
